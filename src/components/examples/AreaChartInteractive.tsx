      ...
      <CardContent className="pt-0">
        <ChartContainer config={chartConfig} className="h-60">
          <AreaChart data={filtered}>
            ...
            <Area dataKey="mobile" type="natural" fill="url(#fillMobile)" stroke="hsl(var(--chart-1))" stackId="a" />
            <Area dataKey="desktop" type="natural" fill="url(#fillDesktop)" stroke="hsl(var(--chart-2))" stackId="a" />
          </AreaChart>
        </ChartContainer>
      </CardContent>
    </Card>
